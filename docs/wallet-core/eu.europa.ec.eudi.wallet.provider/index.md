...
| [WalletKeyManager](-wallet-key-manager/index.md) | [androidJvm]<br>fun interface [WalletKeyManager](-wallet-key-manager/index.md)<br>Manages the cryptographic keys used for Client Authentication and Attestation binding. |

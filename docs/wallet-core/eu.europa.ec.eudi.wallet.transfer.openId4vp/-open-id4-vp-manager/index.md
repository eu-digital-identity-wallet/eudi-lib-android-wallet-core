...
| [reject](reject.md) | [androidJvm]<br>fun [reject](reject.md)()<br>Called when the USER cancels-rejects the transaction from the UI. Uses the cached resolved request object to send the rejection. |

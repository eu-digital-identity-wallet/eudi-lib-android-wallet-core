...
class TransferManagerImpl @JvmOverloads constructor(
     ...
     * @property readerAuthPolicy reader authentication policy (embeds the trust store)
    ...
    class Builder(context: Context) {
         ...
         * The trust store used for certificate validation is embedded in the policy.
        ...
        fun build(): TransferManagerImpl {
            ...
            requireNotNull(readerAuthPolicy) { "Reader auth policy must be provided" }

...
2. 
   It finds all algorithms supported by both server and secureArea
3. 
   The list of matched algorithms is passed to createKeySettingsBuilder
4. 
